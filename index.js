const contentLetterSrart_actived = "Chúc mừng sinh nhật em gái của anh !" //Lời mở đầu cho bức thư
const mainContentLetter = "Thêm tuổi mới. Chúc em luôn mạnh khỏe, hạnh phúc và thành công trên mọi lĩnh vực. Mong rằng những ước mơ và khát vọng của em sẽ trở thành hiện thực, và em sẽ luôn có những người bạn tuyệt vời bên cạnh để chia sẻ những niềm vui và khó khăn trong cuộc sống. Gia đình luôn ở bên cạnh em và sẽ luôn là nơi để em dựa dẫm và tin tưởng. Hãy sống trọn vẹn, yêu thương và hạnh phúc trong mỗi khoảnh khắc của cuộc đời. Chúc em có một sinh nhật thật ý nghĩa và đáng nhớ!" //Nội dung của bức thư
